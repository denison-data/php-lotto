...
include($_SERVER['DOCUMENT_ROOT'].'lotto/www/inc/func/common.php');
		...
		<div class="pro">
			<ul>
				...
				<li class="pro1">
					...
					<p class="p1">45% 할인</p>
					<span>2,000명 제한</span>
					<div class="div1"><img src="http://image.mrlotto.co.kr/prd_label2.jpg"></div>
					...
					<div style="font-size: 0.8rem;text-align: center;padding-top:3px;font-weight: 300;color:#999">판매정책변경 (2019.02.11)</div>
				</li>
