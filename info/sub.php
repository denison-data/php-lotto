...
?>
			<h1>분석 시스템 소개</h1>
			<div style="margin-bottom:30px;position: relative"><img src="/add-img/sub1_img1.jpg">
				<div style="position: absolute;bottom:105px;left:235px"><a href="/member/join.php" style="cursor: pointer"><img src="/add-img/sub1bt.jpg"></a></div>
			</div>
			<div><img src="/add-img/sub1_banner1.jpg"></div>
		</div>
		<!--sub contents end-->
	</div>
	<!--sub title end-->
...
문자 미전송과 관련하여 케이큐는 어떠한 법적책임도 지지 않음을 알려드립니다. (이용약관 3장 11조 10항)</div>
		<?
		$ind1 = 0;
		...
		<div class="sub2_contents">
			...
			<div class="sub2_gold" <? if($ind2=="1"){?>style="margin:-1px 0 50px 0"<? } ?>>
				...
				<img src="/add-img/mobile/soldout.png" style="position: absolute;top:10px; left:42%;z-index: 9999;">
				<?
				}
				?>
				<ul class="ticket_price">
