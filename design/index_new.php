<?php include('header2.php')?>
	...
	<ul>
		<div style="text-align: center;border: 4px solid #e5e5e5;width: 985px;padding:29px 0;float: left;margin-right:10px">
			<ul>
				<h1 style="font-size: 34px;font-weight: 400"><span style="font-size:44px;font-weight: 500;color: #2b76d3">829</span>회 당첨 번호 안내</h1>
				<li>
						...
						<div id="content">
						  ...
						  <!-- end sidebar_right -->
					  			<ul id="slides1">
									<li>
										<div>
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball3.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball9.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball12.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball13.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball25.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball43.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/plus.jpg">
											<img src="http://image.mrlotto.co.kr/ball/new/lot_ball34.jpg">
										</div>
									</li>
									<li>
										<div>
...
최다 당첨번호 및 최저 당첨번호 추출, 홀짝 비율, 고저 비율을 더한 총합, 당첨 조합 끝자리, 끝자리를 모두 더한 끝수 합 등을 분석하여 패턴화 합니다.</p>
		...
		<div class="pro">
			<ul>
				<li class="pro1">
					...
					<div style=";text-align: center"><a href="http://www.mrlotto.co.kr/info/sub.php?dep=2">상품 보러가기</a></div>
				</li>
				<li class="pro1">
					<h5>프리미엄 1년제</h5>
					<p class="p1">45% 할인</p>
					...
					<div style=";text-align: center"><a href="http://www.mrlotto.co.kr/info/sub.php?dep=2#premium1">상품 보러가기</a></div>
				</li>
				...
				<li class="pro1">
					...
					<div style=";text-align: center"><a href="http://www.mrlotto.co.kr/info/sub.php?dep=2#premium2">상품 보러가기</a></div>
				</li>
				<li class="pro1" style="position: relative">
					<h5>실버 2년제</h5>
					<p class="p3">30% 할인</p>
				...
				<li class="pro1">
					...
					<div style=";text-align: center"><a href="http://www.mrlotto.co.kr/info/sub.php?dep=2#silver2">상품 보러가기</a></div>
				</li>
				<li class="pro1">
					<h5>골드 1개월</h5>
					<p class="p3">20% 할인</p>
	...
	<ul style="overflow: hidden;margin-top:45px;">
		<li style="float: left;margin-right:20px"><a href="http://www.mrlotto.co.kr/info/sub.php?dep=1"><img src="http://image.mrlotto.co.kr/bt_banner.jpg"></a></li>
		<li style="float: left">
		...
		<li style="float: left">
			<div style="padding:30px 20px;width: 425px; height: 236px">
				...
				<div style="display: inline-block;width: 240px;text-align: right">
					<select style="border: none;padding-right:20px;font-size:15px">
						<option>[819회] 18.08.11 토요일</option>
						<option>[818회] 18.08.04 토요일</option>
					</select>
				</div>
				<p style="display: block;background-color: #000; text-align: center"><img src="http://image.mrlotto.co.kr/main_video.jpg"></p>
			</div>
		</li>
