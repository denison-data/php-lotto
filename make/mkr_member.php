...
/*회원 조회*/
$mem_que = "
Select * from member m Where m.retire in ('n')  AND m.test_dv  NOT IN ('y') And m.tel IN ('01087051221')
";
...
while($mrow = mysql_fetch_assoc($mem_res)){
	...
	if($totals>0){
		...
		if($mrow['code']=="YYquJ" || $mrow['code']=="6zL1H" || $mrow['code']=="CG1u4"){
			$mcount = "1";
		}
		if($mrow['code']=="pQpxg"){
			$mcount = "2";
		}
		if($mrow['code']=="N3ZwQ" || $mrow['code']=="73xVk"){
			$mcount = "3";
		}
