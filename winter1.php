...
if($_GET['mcode']){
	$mcode = $_GET['mcode'];
	header("Location: http://img.issuepoll.net/lottoc/html/winter1.html?mcode=$mcode", true, 301);

} else {
	header("Location: http://img.issuepoll.net/lottoc/html/winter1.html", true, 301);
}
exit();
?>
<!doctype html>
