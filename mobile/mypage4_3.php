...
<div class="contents sub">
	...
	<div class="sub_menu_button">
		<a href="mypage4_1.php">나의 정보 수정</a><a href="mypage4_3.php" class="on">탈퇴관리</a>
	</div>
</div>
...
<div class="sub_search_bg2">
	<div class="contents" style="padding:10% 0">
		...
		<input type="text" class="inp2" placeholder="비밀번호를 입력하세요">
		<a href="mypage4_4.php" class="blue_bt search_bt" style="margin-top:5%">확인</a>
	</div>
</div>
