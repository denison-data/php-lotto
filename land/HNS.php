	...
	<body style="max-width:900px; margin:0 auto;position: relative">
		...
		<div style="box-shadow:0px 0px 10px;width:70%;background-color: #fff;position:absolute;top:30%;left:15%;z-index: 99999;" id="result_view">
			...
			<div style="background-color:#f8f8f8;padding:2% 7%" class="db">
				...
				<form method="post" action="http://mp.lumieyes.com/ad/01_lotto7/HNS/main_p1.php"  name="Join"  id="Join">
        ...
        <input type="hidden" name="num" value="<?=$_GET[num]?>">
				...
				<div class="ok_bt"><a href="javascript:;" id="create_HNS" ><img src="http://mrlotto.co.kr/land/img/ok_button-1008.jpg"></a></div>
