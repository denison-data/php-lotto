...
<!--
									...
									<label for="agree2">개인정보 수집 및 활용동의</label><a class="btn_popup">[자세히보기]</a> --><div style="text-align: center;padding:1% 0" class="check"><input type="checkbox" style="width: auto;text-decoration: none;color:#666" id="check" checked=""><label style="font-size: 0.8em;color: #111" for="check">&nbsp;&nbsp;개인정보취급방침 동의 <a href="pri.php" target="_blank" style="font-size: 1em;text-decoration: none;color: #888">[약관보기]</a></label></div>
