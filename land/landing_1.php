...
<html lang="ko">
	<head>
		...
		<style>
			body {width:100%;height:100%;background: url('http://img.issuepoll.net/lottoc/land1-bg.jpg');background-size:cover;}
			img {border:0; width:100%}
			.db {background:url('http://img.issuepoll.net/lottoc/db_img-1008.jpg');width:755px; height:803px;margin:0 auto;padding-top:450px;box-sizing: border-box;margin-bottom:100px}
...
include "./jquery.html";
	...
	<body style="max-width:900px; margin:0 auto;">
		<img src="http://img.issuepoll.net/lottoc/land1-img1-1008.png" style="box-sizing: border-box">
		<div class="db">
			<table cellpadding="0" cellspacing="0" border="0" style="margin:0 auto">
				...
				<tr>
					<td><a href="javascript:;" id="create"><img src="http://img.issuepoll.net/lottoc/db_bt-1008.jpg"></a></td>
				</tr>
				<tr>
					<td style="padding-top:15px"><img src="http://img.issuepoll.net/lottoc/ps2.jpg"></td>
				</tr>
			</table>
		</div>
		<footer class="footer" style="width:100%">
			<img src="http://img.issuepoll.net/lottoc/footer-img.jpg">
