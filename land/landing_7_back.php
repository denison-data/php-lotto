...
<html lang="ko">
  ...
  window.onload = function(){
   ...
   window.addEventListener('popstate', function () {       
	   window.location.href = 'http://www.mrlotto.co.kr/';          
  });
...
<div style="border-top:1px solid #ddd;border-bottom:1px solid #ddd;margin-top:5%;padding:2% 5% 2% 3%;font-size:0.8rem;text-align: right;color:#666">
	...
	<SCRIPT language="javascript">
			...
			<br><br><img src="img_181014/news1.jpg">
...
따르면 A씨는매주 1~2장씩 산다고 한다. 로또를 구입하는 이유로는 기대심리와, 생활비, 일확천금 목적이라고 한다. 이날 인터뷰에서 90%이상이 기대심리, 일확천금 목적으로 인터뷰에 답변을 하였다.
    ...
    있어?…'술렁'</p>
    		...
    		<img src="img_181014/img-gif.gif">
			...
			<img src="img_181014/lotto2-1008.jpg">
			<div class="db">
<!-- 				<img src="img_181014/img7.jpg" style="width:100%;padding-left:0"> -->
				<div class="dbdb">
					...
					<a href="javascript:;" id="create" ><img src="http://mrlotto.co.kr/land/img/land6_img3.jpg"></a>
				</div>
			</div>
