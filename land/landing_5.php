...
<html lang="ko">
	<head>
		...
		<style>
			...
			.img1 {width:100%;background: url('/land/img/land5_bg1.jpg'); background-size: contain}
			.img1 img {max-width:900px;}
			.img2 {background: url('/land/img/land5_bg2.jpg') repeat-x; background-size: contain;height:13px}
			.img3 {background-color: #111}
			.img3 img {max-width:900px;}
			.img4 {background: url('/land/img/land5_bg3.jpg') repeat-x; background-size: contain;height:13px}
...
#container .right {
	...
	<body>
		<div class="img1" style="text-align: center"><img src="/land/img/land5_img1-1008.png"></div>
		<div class="img2" style="text-align: center"></div>
		<div class="img3" style="text-align: center"><img src="/land/img/land5_img2.jpg"></div>
		<div class="img4" style="text-align: center"></div>
		<!--머신-->
		<div class="img5" style="text-align: center" >
			<div id="container">
				<p class="left"><img src="/land/img/left.png"></p>
				<p class="right"><img src="/land/img/right.png"></p>
			<!---머신 start-->
				<div id="one">
					<?
					for($i=1;$i<=8;$i++){
			...
			<!---머신 start-->
			<img src="/land/img/land5_bg5.jpg">
			<div class="db" style="text-align: center">
				...
				<a href="javascript:;" id="create"><img src="/land/img/land5_bt.jpg"></a>
			</div>
		</div>
		<footer class=footer>
			<img src="/land/img/footer-img.jpg">
