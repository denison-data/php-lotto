...
<html lang="ko">
	<head>
		...
		<style>
			...
			.tit {padding:30px 0 15px 15px}
			.tit span {padding-left:15px;font-size:22px}
			...
			.quest table td:first-child {width:40px; height:40px; background-color: #111;color:#fff;border-radius: 5px; text-align: center;vertical-align: top;line-height:36px;font-weight:500;font-size:20px}
			...
			@media (max-width:768px){
				...
				.que {padding:40px 0;}
				.quest table td:first-child {width:28px; height:25px; line-height:28px;font-size:14px}
				.quest table td:last-child {font-size:18px; line-height:28px;}
	...
	<body style="max-width:900px; margin:0 auto">
		<div class="tit">
			<a href="http://mrlotto.co.kr" target="_blank"><img src="http://mrlotto.co.kr/land/img/land2-img1.jpg"></a><span>리서치</span>
		</div>
		<div class="border1">
			<div class="border2">
				<div class="contents">
					<div class="que">
						...
						<div class="answer">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td><input type="radio"><label>흥미가 없어서</label></td>
									<td><input type="radio"><label>구매했었지만 당첨이 되지 않아서</label></td>
								</tr>
							</table>
						</div>
					</div>
					<div class="que" style="border-bottom:none">
						...
						<div class="answer">
							<table cellpadding="0" cellspacing="0" border="0">
								<tr>
									<td><input type="radio"><label>Yes</label></td>
									<td><input type="radio"><label>No</label></td>
								</tr>
							</table>
						</div>
					</div>
					<div class="next-bt"><a href="">다음으로</a></div>
				</div>
			</div>
		</div>
		<div class="sns">
