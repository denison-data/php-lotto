...
<html lang="ko">
	<head>
		...
		<style>
			...
			/*background: url('http://img.issuepoll.net/lottoc/light-bg.png') top center no-repeat;background-size: contain;*/
			.land4_rull td {vertical-align: middle;text-align: center;padding:5.5%}
			.txt {margin-top:-10%;background: url('http://img.issuepoll.net/lottoc/land4-bg5.png') center; background-size: cover;}
...
window.onload = function(){
	...
	function endAnimate($n){
		...
		if(part==0){
			gb= 0;
			imgs = "http://img.issuepoll.net/lottoc/n-db1.jpg";
			$("#etc").val("1개월쿠폰");
		} else {
			gb = part;
			imgs = "http://img.issuepoll.net/lottoc/n-db13.jpg";
			$("#etc").val("3개월쿠폰");
   ...
   window.addEventListener('popstate', function () {
	...
	<body style="max-width:700px; margin:0 auto;position: relative">
		<div style="width:100%;background: url('http://img.issuepoll.net/lottoc/n_bg.jpg'); background-size: cover; padding-bottom:27%">
			<div><img src="http://img.issuepoll.net/lottoc/line.jpg"></div>
			<div class="tit"><img src="http://img.issuepoll.net/lottoc/tit.png"></div>
			<div class="light" ><img src="http://img.issuepoll.net/lottoc/light-bg.png"></div>
			<div style="position: absolute;z-index: 99;top:21.4%"><img src="http://img.issuepoll.net/lottoc/rib-bg.png"></div>
		<div class="land4_button"><a href="javascript:;" id="start_btn"><img src="http://img.issuepoll.net/lottoc/start-bt.png" style="width:20.5%"></a></div>
			<table class="land4_rull" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td><img src="http://img.issuepoll.net/lottoc/rull-bg.png" style="width:100%" id="image2"></td>
				</tr>
			<div class="pin"><img src="http://img.issuepoll.net/lottoc/new-pin.png"></div>
			</table>
		</div>
		<!--div class="txt">
			<img src="http://img.issuepoll.net/lottoc/land4-img4-1008.jpg">
		</div-->
		<div><img src="http://img.issuepoll.net/lottoc/use.png"></div>
		<div style="width:100%;margin: 0 auto;height: 100%;background-color: #0d0d0d;position:absolute;top:0;left:0;z-index: 99999;" id="result_view">
			...
			<div style="width:80%;background-color:#0d0d0d; margin: 0 auto;overflow: hidden;" class="db">
				<img src="http://img.issuepoll.net/lottoc/n-db-gif.gif" style="margin-bottom:7%">
				...
				<div style="width: 68%;box-sizing: border-box;float: left;text-align: center;overflow: hidden;margin-top:3%" class="check">
					...
					<label for="check">
						<img src="http://img.issuepoll.net/lottoc/n-db2.jpg" style="width: 60% !important; display: inline-block; vertical-align: middle"> 
						<a href="pri.php" target="_blank" style="width:25%; ">
							<img src="http://img.issuepoll.net/lottoc/n-db3.jpg"  style="width:100%; display: inline-block;vertical-align: middle">
						</a>
					</label>
				</div>
				<div style="width: 32%;box-sizing: border-box;float: left;text-align: right;overflow: hidden;margin-top:3%" class="check2">
					...
					<label for="check2">
						<img src="http://img.issuepoll.net/lottoc/n-db4.jpg" style="width: 84% !important; vertical-align: middle">
					</label>
				</div>
				...
				<div class="ok_bt"><a href="javascript:;" id="create"><img src="http://img.issuepoll.net/lottoc/n-db5.jpg"></a></div>
			<div>
				<img src="http://img.issuepoll.net/lottoc/n-db6.jpg">
			</div>
			</div>
		</div>
		<footer class="footer" style="width:100%">
			<img src="http://img.issuepoll.net/lottoc/txt.png">
			<img src="http://img.issuepoll.net/lottoc/txt22.png">
