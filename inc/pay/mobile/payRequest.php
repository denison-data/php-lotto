...
*******************************************************
*/
$merchantKey      = "frqTnzaF1mP3Zo+TVsCKnN3Nq4gqSMZLp0nte2pL+dfF9whV0JdRh+cKwABcKwWWvySmPxJ5kSKtzLq1qtwVrQ==";   // 상점키
$merchantID       = "APG033295m";                                                       // 상점아이디
$goodsCnt         = "1";                                                                // 결제상품개수
$goodsName        = "루미너스아이즈";                                                       // 결제상품명
$price            = "1004";                                                             // 결제상품금액	
$buyerName        = "나이스";                                                           // 구매자명
$buyerTel         = "01000000000";                                                      // 구매자연락처
$buyerEmail       = "happy@day.co.kr";                                                  // 구매자메일주소
$moid             = "mnoid1234567890";                                                  // 상품주문번호
$ReturnURL        = "http://www.mrlotto.co.kr/inc/pay/mobile/payResult.php";                // Return URL
