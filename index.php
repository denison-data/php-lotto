...
<ul>
					  			...
					  			<ul id="slides1">
									...
									<li>
										...
										<div>
											...
											<img src="./add-img/ball/new/lot_ball<?=$arr[$field]?>.jpg">
											<? } ?>												
											<img src="./add-img/main_lotto_plus.jpg" class="plus">
											<img src="./add-img/ball/new/lot_ball<?=$arr['bonus'];?>.jpg">
		...
		<div style="width: 284px;float: left">
				...
				<li>
					...
					<div class="main_login">
						...
						<div class="main_login_bt2">
							...
							<a class="main_naver_login_bt" name="네이버 로그인"  href="javascript:alert('포트폴리오 페이지입니다.\n위 서비스는 더이상 이용하실 수 없습니다.\n');" id="naver_id_login">네이버 로그인</a>
						</div>
					</div>
			...
			<div id="main_bn">
				<li>
					<img src="./add-img/right_banner1.jpg">
				</li>
				<li>
					<img src="./add-img/right_banner2.jpg">
				</li>
			</div>
...
최다 당첨번호 및 최저 당첨번호 추출, 홀짝 비율, 고저 비율을 더한 총합, 당첨 조합 끝자리, 끝자리를 모두 더한 끝수 합 등을 분석하여 패턴화 합니다.</p>
					<img src="./add-img/new_chart1.jpg">
				</li>
				<li>
					...
					<img src="./add-img/new_chart2.jpg">
				</li>
				<li>
					...
					<img src="./add-img/new_chart3.jpg">
				</li>
				<li>
					<h4 style="font-size: 20px;font-weight: 400;padding:20px 0 10px 0 ">변수 제거 시스템(Variable emoval System)</h4>
					<p style="padding-bottom:30px">체계적인 패턴 필터링 후 조합 변수를 제거하는 작업을 거칩니다. 1,2단계를 거친 누적 데이터를 기반으로 한 데이터 베이스를 반영하여 가장 최적화 된 추첨 패턴을 적용합니다. 선별된 패턴 내에도 동일한 작업이 이루어지며, 당첨 번호 출현 가능 범위를 압축하여 변수를 제거 합니다.</p>
					<img src="./add-img/new_chart4.jpg">
				</li>
				<li>
					...
					<img src="./add-img/new_chart5.jpg">
				</li>
	            <div id="main_bn_btn">
	                <li><a href="#"><img src="./add-img/blt.jpg"></a></li>
	                <li><a href="#"><img src="./add-img/bltout.jpg"></a></li>
	                <li><a href="#"><img src="./add-img/bltout.jpg"></a></li>
	                <li><a href="#"><img src="./add-img/bltout.jpg"></a></li>
	                <li><a href="#"><img src="./add-img/bltout.jpg"></a></li>
	            </div>
		...
		<div style="float: left; width: 635px; vertical-align: top;">
			<img src="./add-img/notice_img.jpg" style="display: inline-block;margin:0 10px"><h2 style="display: inline-block;vertical-align: top;font-size:26px; font-weight: 400">공지사항</h2>
			<span style="vertical-align: top;margin-left:15px;font-size:18px">미스터로또씨 공지사항 게시판의 게시글 영역입니다.</span>
			<img src="./add-img/bigbanner.jpg" style="margin-top:10px">
		</div>
	</ul>	
	<ul>
		<h2 style="font-size:26px;line-height: 26px;margin:0 0 15px 20px;font-weight: 400">상품 소개</h2>
		<style>
			.pro .pro1 {width:205px !important; height:320px !important}
			.pro .pro1 .p2 {padding-bottom:25px !important}
			.pro .pro1 .soldout_bg {width:205px !important; height:320px !important}
			.div1 {text-align: left !important;padding-left:15px !important}
		</style>
		<div class="pro">
			<ul>
				<li class="pro1">
					...
					<p class="p1">50% 할인</p>
					<span>300명 제한</span>
					<div class="div1"><img src="./add-img/prd_label.jpg"></div>
				...
				<li class="pro1">
					...
					<p class="p1">45% 할인</p>
					<span>2,000명 제한</span>
					<div class="div1"><img src="./add-img/prd_label2.jpg"></div>
					...
					<div style="font-size: 0.7rem;text-align: right;padding-top:3px;font-weight: 300;color:#999;padding-right:15px">판매정책변경 (2019.02.11)</div>
				</li>
				<li class="pro1" style="position: relative">
					...
					<div class="soldout" style="position: absolute;z-index:100;bottom:-23px; right:-20px; "><img src="./add-img/new_soldout.png"></div>
				</li>
				<li class="pro1" style="position: relative">
					<h5>골드 1년제</h5>
					<p class="p3">35% 할인</p>
					...
					<div class="soldout_bg"></div>
					<div class="soldout"><img src="./add-img/new_soldout.png"></div>
				</li>
				<!--li class="pro1" style="position: relative">
					<h5>실버 2년제</h5>
					<p class="p3">30% 할인</p>
				...
				<li class="pro1">
					<h5>실버 1년제</h5>
					<p class="p3">25% 할인</p>
					<div class="div2"><s>200,000원</s></div>
					<p class="p2">149,000원</p>
					<div style=";text-align: center"><a href="/info/sub.php?dep=2#silver1">상품 보러가기</a></div>
				</li>
				<li class="pro1">
					<h5>골드 1개월</h5>
					<p class="p3">20% 할인</p>
	...
	<ul>
		<div style="background: url('./add-img/awards_bg.jpg') no-repeat; width: 1280px; height:319px">
			
			<div class="autoplay" style="width: 890px;padding:115px 0 0 37px;box-sizing: border-box">		
			    <div><img src="./add-img/lotto1.jpg"></div>
			    <div><img src="./add-img/lotto2.jpg"></div>
			    <div><img src="./add-img/lotto3.jpg"></div>
			    <div><img src="./add-img/lotto4.jpg"></div>
			    <div><img src="./add-img/lotto5.jpg"></div>
			    <div><img src="./add-img/lotto6.jpg"></div>
			    <div><img src="./add-img/lotto7.jpg"></div>
			    <div><img src="./add-img/lotto8.jpg"></div>
			    <div><img src="./add-img/lotto9.jpg"></div>
			    <div><img src="./add-img/lotto10.jpg"></div>
			    <div><img src="./add-img/lotto11.jpg"></div>
			    <div><img src="./add-img/lotto12.jpg"></div>
			    <div><img src="./add-img/lotto13.jpg"></div>
			    <div><img src="./add-img/lotto14.jpg"></div>
			    <div><img src="./add-img/lotto15.jpg"></div>
			    <div><img src="./add-img/lotto16.jpg"></div>
			    <div><img src="./add-img/lotto17.jpg"></div>
			    <div><img src="./add-img/lotto18.jpg"></div>
			    <div><img src="./add-img/lotto19.jpg"></div>
			    <div><img src="./add-img/lotto20.jpg"></div>
			    <div><img src="./add-img/lotto21.jpg"></div>
			    <div><img src="./add-img/lotto22.jpg"></div>
			    <div><img src="./add-img/lotto23.jpg"></div>
			    <div><img src="./add-img/lotto24.jpg"></div>
			    <div><img src="./add-img/lotto25.jpg"></div>
			    <div><img src="./add-img/lotto26.jpg"></div>
			</div>
			
		</div>
	</ul>
	<ul style="overflow: hidden;margin-top:45px;">
		<li style="float: left;margin-right:20px"><a href="/info/sub.php?dep=1"><img src="./add-img/bt_banner.jpg"></a></li>
		<li style="float: left">
			...
			<div>
				...
				<ul style="overflow: hidden;border: 1px solid #e5e5e5;width:630px;border-radius: 10px;padding:8px 0 8px 35px">
					<li style="float: left;padding-right:20px;"><img src="./add-img/new_thum1.jpg"></li>
...
text-overflow: ellipsis ;">더욱더 확률이 높아진 로또번호조합을 무료로 받아가세요</p></li>
				...
				<ul style="overflow: hidden;border: 1px solid #e5e5e5;width:630px;border-radius: 10px;padding:8px 0 8px 35px;margin-top:10px">
					<li style="float: left;padding-right:20px"><img src="./add-img/new_thum2.jpg"></li>
	...
	<ul style="border: 1px solid #e5e5e5;margin-top:20px;overflow: hidden">
		<li style="float: left">
			<div style="padding:30px 20px;width: 425px; height: 236px">
				...
				<p style="display: block;background-color: #000; text-align: center" id="brod_img"><img src="./add-img/main_video.jpg"></p>
			</div>
		</li>
		<li style="float: left;border-left:1px solid #e5e5e5;border-right:1px solid #e5e5e5">
			<div style="padding:30px 20px;width: 425px; height: 236px">
				...
				<p style="font-size:50px;font-weight: 600;letter-spacing: 0; color: #2b76d3;padding:30px 0 38px 0">1811-7335</p>
		...
		<li style="float: left">
			<div style="width: 425px; height: 236px">
				...
				<ul style="overflow: hidden;padding-left:20px;">
					<li style="display: inline-block;vertical-align: top"><img src="./add-img/ibk.jpg"></li>
					<li style="display: inline-block;padding-left:20px">
						<p style="font-size:30px;font-weight: 400;padding-bottom:8px">110-459-382099</p>
						<p>예금주 : 조정윤</p>
					</li>
				</ul>
